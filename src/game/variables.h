...
MACRO_CONFIG_STR(PlayerSkin, player_skin, MAX_SKIN_ARRAY_SIZE, "default", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player skin")
MACRO_CONFIG_STR(PlayerSkinBody, player_skin_body, MAX_SKIN_ARRAY_SIZE, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player skin body")
MACRO_CONFIG_STR(PlayerSkinMarking, player_skin_marking, MAX_SKIN_ARRAY_SIZE, "", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player skin marking")
MACRO_CONFIG_STR(PlayerSkinDecoration, player_skin_decoration, MAX_SKIN_ARRAY_SIZE, "", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player skin decoration")
MACRO_CONFIG_STR(PlayerSkinHands, player_skin_hands, MAX_SKIN_ARRAY_SIZE, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player skin hands")
MACRO_CONFIG_STR(PlayerSkinFeet, player_skin_feet, MAX_SKIN_ARRAY_SIZE, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player skin feet")
MACRO_CONFIG_STR(PlayerSkinEyes, player_skin_eyes, MAX_SKIN_ARRAY_SIZE, "standard", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player skin eyes")
...
MACRO_CONFIG_INT(SvCountdown, sv_countdown, -1, -1, 1000, CFGFLAG_SAVE|CFGFLAG_SERVER, "Number of seconds to freeze the game in a countdown before match starts (0 enables only for survival gamemodes, -1 disables)")
...
MACRO_CONFIG_INT(SvPlayerSlots, sv_player_slots, 16, 0, MAX_CLIENTS, CFGFLAG_SAVE|CFGFLAG_SERVER, "Number of slots to reserve for players")
