...
// physics tuning
MACRO_TUNING_PARAM(GroundControlSpeed, ground_control_speed, 0.f)
MACRO_TUNING_PARAM(GroundControlAccel, ground_control_accel, 0.f)
MACRO_TUNING_PARAM(GroundFriction, ground_friction, 0.f)
MACRO_TUNING_PARAM(GroundJumpImpulse, ground_jump_impulse, 0.f)
MACRO_TUNING_PARAM(AirJumpImpulse, air_jump_impulse, 0.f)
MACRO_TUNING_PARAM(AirControlSpeed, air_control_speed, 0.f)
MACRO_TUNING_PARAM(AirControlAccel, air_control_accel, 0.f)
MACRO_TUNING_PARAM(AirFriction, air_friction, 0.f)
MACRO_TUNING_PARAM(HookLength, hook_length, 0.f)
MACRO_TUNING_PARAM(HookFireSpeed, hook_fire_speed, 0.f)
MACRO_TUNING_PARAM(HookDragAccel, hook_drag_accel, 0.f)
MACRO_TUNING_PARAM(HookDragSpeed, hook_drag_speed, 0.f)
MACRO_TUNING_PARAM(Gravity, gravity, 0.f)
...
MACRO_TUNING_PARAM(LaserReach, laser_reach, 1600.0f)
