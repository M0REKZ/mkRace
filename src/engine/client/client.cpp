...
void CClient::Render()
{
	...
	{
		if(Config()->m_GfxClear || Config()->m_GfxGameTiles >= 2)
		{
			vec3 RGBClearColor = vec3((Config()->m_GfxClearColor>>16&0xff)/255.0f,(Config()->m_GfxClearColor>>8&0xff)/255.0f,(Config()->m_GfxClearColor&0xff)/255.0f);
