...
MACRO_CONFIG_STR(PlayerName, player_name, MAX_NAME_ARRAY_SIZE, "nameless tee", CFGFLAG_SAVE|CFGFLAG_CLIENT, "Name of the player")
MACRO_CONFIG_STR(PlayerClan, player_clan, MAX_CLAN_ARRAY_SIZE, "", CFGFLAG_SAVE|CFGFLAG_CLIENT, "Clan of the player")
...
MACRO_CONFIG_INT(SvXXLDDRace, sv_xxlddrace, 0, 0, 1, CFGFLAG_SERVER, "Toggle XXLDDRace features")
MACRO_CONFIG_INT(SvPauseable, sv_pauseable, 0, 0, 1, CFGFLAG_SERVER, "Whether players can pause their char or not")
